...
func (h Resources) MountRoutes(r chi.Router, middlewares ...func(http.Handler) http.Handler) {
	r.Group(func(r chi.Router) {
		...
		r.Put("/resources/compose/namespaces/{namespaceID}/meta", h.ComposeNamespacesMeta)
		r.Put("/resources/compose/namespaces/{namespaceID}/modules/{moduleID}/meta", h.ComposeModuleMeta)
	})
}
